# How to contribute to Pouchdb playground?
...
- What is the version of the Pouchdb playground app?
...
```
$ git clone github.com/paultranvan/pouchdb-playground.git
$ cd pouchdb-playground
$ git remote add fork git://github.com/yourusername/pouchdb-playground.git
```
...
Go to https://github.com/yourusername/pouchdb-playground and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Pouchdb playground is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/paultranvan/pouchdb-playground/issues/new
...
[localization]: https://github.com/paultranvan/pouchdb-playground/blob/master/README.md#localization
