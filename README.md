[![Travis build status shield](https://img.shields.io/travis/paultranvan/pouchdb-playground/master.svg)](https://travis-ci.org/paultranvan/pouchdb-playground)
[![Github Release version shield](https://img.shields.io/github/tag/paultranvan/pouchdb-playground.svg)](https://github.com/paultranvan/pouchdb-playground/releases)
...
Hacking the Cozy Pouchdb playground app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/paultranvan/pouchdb-playground.git
$ cd pouchdb-playground
$ yarn install
```
...
After the build and the docker image launched, your app is now available at http://pouchdb-playground.cozy.tools:8080.
...
If you want to work on Pouchdb playground and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for Pouchdb playground is [paultranvan](https://github.com/paultranvan), send him/her a :beers: to say hello!
...
Pouchdb playground is developed by paultranvan and distributed under the [AGPL v3 license][agpl-3.0].
